...
% locations (xyz) in m
motor(1).location = [[sind(270),cosd(270)]*480*0.5,0] * 0.001; % LEFT
motor(2).location = [[sind(90),cosd(90)]*480*0.5,0] * 0.001; % RIGHT
motor(3).location = [[sind(0),cosd(0)]*480*0.5,0] * 0.001; % FRONT
motor(4).location = [[sind(180),cosd(180)]*480*0.5,0] * 0.001; % BACK
